...
**【摘要】**生成式人工智能进入小学语文课堂后，互动主体由“教师—学生”扩展为“教师—AI—学生”。这一变化并不等于互动质量自动升级。课堂观察与课例分析表明：若组织方式、权责关系与技术边界不同步重构，技术在场仍可能固化放射状问答、边缘化部分学生，并以人机输出冒充概念交互与情意回应。《义务教育语文课程标准（2022年版）》强调平等对话；教育部基础教育教学指导委员会《中小学生成式人工智能使用指南（2025年版）》提出“育人为本、技术为用”，明确教师不得将生成式人工智能作为替代性教学主体，小学阶段学生不得独自使用开放式内容生成功能。本文以“问题—策略—结果”为闭环，将形式、关系、技术三类失衡分别对应破程、复权、守界三阶校准，构建“三层互动×三元主体×三阶校准”模型，并提供可观察的编码体系与六维量表。核心论断是：有效的三元协同不是三方平均用力，而是使AI成为支架、教师成为引领者、学生成为意义建构者，推动互动由操作交互经信息交互抵达概念交互，并守住情意共鸣。本文证据以课堂观察、课例分析与政策文本为主，公开报道数据仅作侧面说明，不外推为普遍因果效应。
...
缘起。课堂互动从来不是“提问—回答”的流程表演。符号互动理论指出，人依靠语言、神态与姿态理解彼此意图，并在理解中调整行为。完整的课堂互动包含主体、情境、过程与结果：主体是否在场，情境是否真实，过程是否生成。三者缺一，互动便退化为程式。陈丽提出的教学交互层次塔将交互区分为操作交互、信息交互与概念交互：会点选、会投屏，属于操作交互；交换关键词与资料，多属信息交互；围绕文本证据发生新旧概念碰撞，才进入概念交互。情意回应无法被算法完整代理，应作为概念交互之上必须由人守住的一层。

![](figures/fig01.jpg)

**图1　教学交互层次模型（操作—信息—概念，并守住情意共鸣）**

政策依据。2025年教育部基础教育教学指导委员会发布的《中小学生成式人工智能使用指南》将生成式人工智能界定为能够生成文本、图片、音频、视频等内容的模型及相关技术，强调“育人为本、技术为用”，要求分学段差异化应用，并明确小学阶段学生应在教师或家长帮助下使用开放式内容生成功能，教师不得将其作为替代性教学主体。UNESCO《教师人工智能能力框架》（2024）指出，人工智能正在使传统的“教师—学生”关系转变为“教师—AI—学生”动态关系，但核心仍是人的主体性、伦理与教学法。上述政策与国际框架构成本文权责边界的外部依据。

方法说明。本文采用课例分析、课堂观察与政策文本解读。课例来自统编教材常态课与公开教学展示，包括《守株待兔》《火烧云》《手指》《小青蛙》《我们家的男子汉》，以及习作课《我的植物朋友》《即景》《这儿真美》《奇妙的想象》，阅读课《古人谈读书》《棉花姑娘》《大象的耳朵》等。区域教研中“赋能·分层·共生”的习作集备与“个案—共案—特案—定案”的备课闭环，为策略落地提供过程性参照。观察用于识别互动结构，而非进行未交代样本的统计推断。文中课例只讨论教学设计与互动结构，不标注执教者个人身份信息。凡引用公开报道中的准确率数据，均标明来源层级，不作为本研究实验数据。

核心论断。生成式人工智能进入小学语文课堂，并不意味着互动主体简单增加，而意味着组织方式、权责关系和技术边界必须同步重构。真正有效的三元协同，不是让教师、AI、学生三方平均用力，而是通过破程、复权、守界，使AI成为支架、教师成为引领者、学生成为意义建构者，最终推动课堂互动由操作交互走向信息交互、概念交互与情意共鸣。
...
### （一）形式失衡：程式问答，遮蔽多向互动
问题透视。形式失衡的病灶，是把互动窄化为“教师一呼、学生百应”的放射状问答，多向通道尚未打开，深度互动被流程遮蔽。
...
#### 2. 参与失衡：少数发言，主体难以全面进入
在秧田式座位与教师独占讲台的空间结构中，身体在场并不等于话语在场。持续观察可见：部分学生整节课缺少有效口头互动机会，内向学生与表达较弱的学生在放射状问答中更容易处于旁观位置。此处不将“近三分之一”作为未交代样本量、观察课数与操作性定义的统计数据。可观察的事实是：发言机会向少数被教师熟悉、表达流畅的学生集中；小组合作中常见“一人说、众人听”。小学生面对同伴本更敢提问、敢纠错，多数课堂却压缩合作探究。生成式工具本可归集不同想法，若只被用作习题训练与投屏，技术在场而通道仍旧只有一条。

#### 3. 生成受限：教案固化，课堂难以容纳意外
症结剖析。教师担心小组活动打乱节奏、耽误知识点落实，于是把问答流程写进教案的每一分钟：先问什么、谁来答、标准句是哪一句，全预置完毕。课堂追求永远的有序，容不得“失衡后的再平衡”。一旦教案被执行完毕，互动就被宣告完成。形式失衡看起来是“问法单一”，根子却是不敢把时间交给不确定的对话。生成式人工智能若在此时被用来预先生产“标准赏析”，只会进一步压缩生成空间。

### （二）关系失衡：主客固化，消解平等交往
问题透视。完整互动包含认知互动、情意互动和行为互动。关系失衡的病灶，是发起权、可见权与判断权持续集中于教师及少数学生，平等交往名存实亡。
...
#### 3. 权责模糊：技术介入，师生关系反而弱化
原因探寻。教师若固守“唯一正确声音”，把师生互动等同于课堂提问，便没有把交往看作教学的本质。评价层面，学校仍优先考量进度与知识点覆盖等可量化指标，教师担心开放探究耽误课时。学生层面，倾听、表达、反思、合作缺少常态化训练，即便给了机会，也难以开展高质量对话。生成式人工智能介入后，若教师把提问权、评价权进一步让渡给机器，师生关系不是被增强，而是被稀释：教师从对话者变成播放者，学生从建构者变成校对者。

### （三）技术失衡：工具越位，遮蔽真实对话
问题透视。技术失衡不是“用了AI”，而是AI从支架变成新的特权者：替学生思考，替教师判断，用人机问答冒充师生之间的心灵交往。
...
#### 3. 替证现象：工具出场，被误认为课堂升级
把是否使用生成式人工智能当作课堂先进的证明，是第三类越位。人与技术的互动若引导不当，会高度集中于媒体演示、即时检索等操作层面，用于创作、表达、质疑的互动偏少。操作交互的流畅，不能等同于概念交互的发生。权责边界一旦模糊，AI就会从支架变成课堂里新的特权者。底线其实清楚：情感体察与价值判断必须由人完成。
...
**图15　习作《我的植物朋友》：任务要求投屏，先观察记录再书面表达**
...
#### 1. 禁替终答：先思后比，守住自主思考过程
铁律一：可以给问题、给材料、给归集，不可以给本课终答。操作上把“标准赏析”折叠到学生独立表达之后，只作对照。这与小学阶段限制独自开放生成、禁止复制生成内容作为作业答案的政策要求一致。

#### 2. 护航情意：出错先护，评分不得当众惩戒
行动实施。学生读错、说错时，先保护自尊心，再引导回到文本。约定三条：当众不展示带羞辱性的机器分数；先问“你刚才看到了什么／想到了什么”，再范读或同伴带读；分数与等级留到课后单独查看，并与下一次进步对照，而不是与全班排名对照。铁律二：机器评分可以课后看，不可以当众惩。
...
#### 3. 证伪机器：据文校验，破除工具即升级观
教学实践。对生成的释义、赏析、学情标签尤须审慎：活跃度低不能直接等同于“不认真”。更关键的示范是：当着学生的面质疑生成内容，用课文证伪“很会说话”的句子。铁律三：任何生成句子上屏，都必须经过“课文里有没有依据”这一问。

**【案例举隅8】三年级下册《守株待兔》：用文本证据否定“正能量改写”**
课后拓展时，有工具把寓言解读为“等待也是一种策略，机会总是留给有准备的人”。教师把这句话投在屏幕上，请学生回到课文找依据：庄稼完了没有？邻居怎么说？宋人最后的结果是什么？学生很快发现，文本里没有任何一处支持这种解读。教师小结应落在论断而非金句：生成文本可以流畅，但不等于已经完成对该课文的意义建构；读书的人要自己判断。当学生看到教师当场质疑工具，“机器说的就是对的”这一默认印象才会松动，思维互动才进入概念交互。
...
#### 2. 观察入表：六维编码，覆盖层次情意对照
把评课从“用了几个工具”转到可观察、可记录、可复盘的工具。六维雷达图仅作评价框架示意，不填写无完整数据的实验前后分数。

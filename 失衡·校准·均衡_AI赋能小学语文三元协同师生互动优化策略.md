...
## 一、审视——三元协同课堂互动失衡之困
生成式人工智能进了小学语文课堂，互动主体多出一方，旧的问答结构却常常原样保留。全国教学展示课和区域第一学段阅读研讨的现场，把这一点摊得很清楚：学生仍坐成行列，目光对着屏幕或讲台，发言以举手应答为主。屏幕上可以出现谜语、任务要求和学生习作，这些只能说明信息已经公共化，不能说明对话已经转向多向。叶子、庞丽娟把师生互动看作教学过程的基本构成，强调双向、交互与连续；符号互动理论也指出，人要靠语言和姿态理解彼此意图。缺了思考机会、缺了来自文本的真问题、缺了教案之外可被接住的想法，互动就会退回程式。本文要问的不是“有没有用AI”，而是谁、在什么场景、缺什么。形式管通道，关系管发言权，技术管边界。三层不是并列口号，而是一层卡住、下一层跟着走偏。

![](figures/fig01.jpg)

**图1　教学交互层次模型（操作—信息—概念，并守住情意共鸣）**

陈丽的教学交互层次塔原用于远程学习。拿到小学语文面授课里，只作一把尺子：会点选、会投屏，停留在操作层；关键词和习作上屏，进入信息层；新旧观念在课文证据上碰撞，才到概念层。情意回应无法由算法完整承担，须由人接着做完。下面先看通道有没有打开。
